...
var Book = /*#__PURE__*/function () {
  ...
  _createClass(Book, [{
    ...
    value: function createBook() {
      var containerBook = document.createElement("div");
      containerBook.classList.add("col-md-3");
      var cardBook = document.createElement("div");
      ...
      var titleBook = document.createElement("h3");
      titleBook.classList.add("card-title");
      titleBook.textContent = this.title;
      var authorBook = document.createElement("p");
...
form.addEventListener('submit', function (event) {
  ...
  var titleBookInput = document.querySelector('#bookTitle');
  var imageBookInput = document.querySelector('#urlimage');
  var authorBookInput = document.querySelector('#author');
  var title = titleBookInput.value;
  var author = authorBookInput.value;
  var image = imageBookInput.value;
  var book1 = new _book.default(title, author, image);
  var containerBook = book1.createBook();
...
},{"./book.js":"book.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
